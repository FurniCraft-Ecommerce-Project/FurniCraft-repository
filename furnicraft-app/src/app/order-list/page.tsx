                ...
                >
                  ...
                  <div className="p-3 flex justify-between items-center border-b border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-md font-bold ${getStatusBgColor(
                          order.status
                        )}`}
                      >
                    ...
                    {order.status.toLowerCase() === "pending" ? (
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        {["placed", "processed", "shipped", "delivered"].map(
                          (step, i, arr) => {
                            const currentStep =
                              order.deliveryStatus || "pending"; // fallback
                            ...
                            > = {
                              ...
                              shipped: {
                                icon: (
                                  <Truck className={`w-5 h-5 ${getColor()}`} />
                                ),
                                text: "Shipped",
                              },
                              delivered: {
                        ...
                        <div className="flex gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {order.items[0].quantity} item x{" "}
                              {formatRupiah(order.items[0].price)}
                            </p>
