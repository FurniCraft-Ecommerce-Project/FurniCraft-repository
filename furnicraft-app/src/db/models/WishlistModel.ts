...
class WishlistModel {
    ...
    static async addWishlist ({UserId, ProductId} : {UserId : string, ProductId : string}) {
        return await this.collection().insertOne({UserId : new ObjectId(UserId), ProductId : new ObjectId(ProductId)});
    }
